...
echo "-----------------------------------------------------"
echo "STARTING drought_map_hub RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./drought_map_hub/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED drought_map_hub RESTORE $(date)"
echo "-----------------------------------------------------"
