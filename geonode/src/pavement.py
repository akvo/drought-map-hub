...
try:
    from drought_map_hub.local_settings import *
except ImportError:
    from drought_map_hub.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf drought_map_hub/development.db")
    sh("rm -rf drought_map_hub/uploaded/*")
    _configure_data_dir()
