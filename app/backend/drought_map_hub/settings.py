"""
Django settings for drought_map_hub project.
...
TEMPLATES = [
    {
        ...
        "DIRS": [Path.joinpath(BASE_DIR, "drought_map_hub/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "drought_map_hub.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "drought_map_hub",
    "DESCRIPTION": "API for drought_map_hub",
    "VERSION": "1.0.0",
...
GEONODE_HOST = environ.get("GEONODE_HOST", "localhost")
